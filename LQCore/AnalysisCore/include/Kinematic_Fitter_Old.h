...
class Kinematic_Fitter_Old : public Kinematic_Fitter_Base
{
 public:
  ...
  virtual void Fit();
  virtual void Set(const TLorentzVector& a_met, const TLorentzVector& a_lepton, const vector<snu::KJet>& a_jet_vector, const Bool_t* a_target_jet, const Bool_t a_b_tag[4]);
