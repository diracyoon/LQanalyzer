...
Kinematic_Fitter_2::Kinematic_Fitter_2(const Bool_t& a_chk_high_mass_fitter, const Int_t& ts_correction_type, const Bool_t& a_chk_debug) : Kinematic_Fitter_Base(a_chk_high_mass_fitter, ts_correction_type, a_chk_debug)
{
