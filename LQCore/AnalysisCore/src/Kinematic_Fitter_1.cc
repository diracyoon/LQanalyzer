...
void Kinematic_Fitter_1::Set(const TLorentzVector& a_met, const TLorentzVector& a_lepton, const vector<TLorentzVector>& a_jet_vector, const Bool_t* a_target_jet, const Bool_t* a_b_tag)
{
  measured_met = a_met;
  ...
  return;
}//void Kinematic_Fitter_1::S

//////////

void Kinematic_Fitter_1::Fit()
{
