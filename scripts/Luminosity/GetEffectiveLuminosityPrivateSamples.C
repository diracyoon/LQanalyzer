...
void GetEffectiveLuminosityPrivateSamples()
{
  ...
  catversion_map["CHToCB_M090_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M100_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M110_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M120_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M125_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M130_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M140_madgraph_13TeV_2016"] = "v8-0-7";
  catversion_map["CHToCB_M150_madgraph_13TeV_2016"] = "v8-0-7";
  ...
  for(std::map<TString, Double_t>::iterator mit =xsmap.begin(); mit != xsmap.end();++mit)
    {
      ...
      if(mitv== catversion_map.end()) 
	{
	  cout << "Error in naming datasets in map" << endl; 
	  return;
	}
      version= mitv->second;
